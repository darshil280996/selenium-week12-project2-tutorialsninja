...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.xpath("//input[@id='input-firstname']"), "danny");

        // 3.4 Enter Last Name
        sendTextToElement(By.xpath("//input[@id='input-lastname']"), "daniels");

        // 3.5 Enter Email
        sendTextToElement(By.xpath("//input[@id='input-email']"), "dannydaniels100@gmail.com");

        // 3.6 Enter Telephone
        sendTextToElement(By.xpath("//input[@id='input-telephone']"), "1234567890");

        // 3.7 Enter Password
        sendTextToElement(By.xpath("//input[@id='input-password']"), "dd@123");

        // 3.8 Enter Password Confirm
        sendTextToElement(By.xpath("//input[@id='input-confirm']"), "dd@123");
